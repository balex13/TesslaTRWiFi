...
public class SyncUtils {
    private static final long SYNC_FREQUENCY = 5 * 60;  // 1 hour (in seconds)
    private static final String PREF_SETUP_COMPLETE = "setup_complete";
    // Value below must match the account type specified in res/xml/syncadapter.xml
    public static final String CONTENT_AUTHORITY = "com.abomko.tesslatrwifi";
    public static final String ACCOUNT_TYPE = "com.abomko.tesslatrwifi.account";
